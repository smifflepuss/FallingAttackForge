...
public abstract class LocalPlayerMixin extends PlayerMixin {
    ...
    @Nonnull
    protected CameraType camTypeWhenAtk = CameraType.FIRST_PERSON;
    ...
    public void startFallingAttack() {
        ...
        if (Config.Client.THIRD_PERSON.get()) {
            this.camTypeWhenAtk = this.minecraft.options.getCameraType();
    ...
    public void stopFallingAttack() {
        ...
        if (Config.Client.THIRD_PERSON.get()) {
            ...
            this.minecraft.options.setCameraType(this.camTypeWhenAtk);
