...
public class JsonConfig {
    ...
    private synchronized void load() {
        try (InputStreamReader fileReader = new InputStreamReader(new FileInputStream(this.file), StandardCharsets.UTF_8)) {
    ...
    protected synchronized void save() {
        try (JsonWriter jsonWriter = new JsonWriter(new OutputStreamWriter(new FileOutputStream(this.file), StandardCharsets.UTF_8))) {
